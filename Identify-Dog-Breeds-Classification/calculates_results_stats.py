...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        # identify dog and non-dog images 
        if results_dic[key][3] == 1: 
            # B
            results_stats_dic['n_dogs_img'] += 1
            
            # the image is dog and classification is dog
    ...
    if (results_stats_dic['n_notdogs_img'] > 0):
        value = results_stats_dic['n_correct_notdogs'] / results_stats_dic['n_notdogs_img'] * 100
        results_stats_dic['pct_correct_notdogs'] = value
    else: 
