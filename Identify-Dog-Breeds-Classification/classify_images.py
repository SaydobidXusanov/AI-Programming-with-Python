...
def classify_images(images_dir, results_dic, model):
    ...
    """
    # Classify images and generate the necessary list
    for image in results_dic:
        classifier_label = classifier(images_dir + image, model).lower().strip()
        ...
        if results_dic[image][0].lower() in classifier_label.lower():
